...
def main():
    ...
    if args.markdown_source is not None and os.path.exists(args.markdown_source[0]):
        with tempfile.TemporaryDirectory() as td:
            ...
            file_util.copy_file('PGpILjA.png', td)
            file_util.copy_file('sasjscompile.png', td)
            file_util.copy_file('ArrTyCY.png', td)
            file_util.copy_file('deployworkflow.png', td)
            file_util.copy_file('7oxNugk.png', td)
            file_util.copy_file('lineage.png', td)
            file_util.copy_file('PGpILjA.png', td)
            file_util.copy_file('sasjsdoc.png', td)
